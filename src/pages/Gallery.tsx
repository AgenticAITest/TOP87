    ...
    <section className="py-24 px-6 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12">
          <div>
            <span className="text-xs font-bold tracking-[0.3em] uppercase text-gold mb-2 block">Memories</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white font-serif">Gallery</h2>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full md:w-auto">
            <Link to="/submit"
              className="flex items-center gap-2 bg-gold hover:bg-gold/90 text-charcoal font-bold py-2 px-5 rounded-full text-xs uppercase tracking-widest transition-all shrink-0">
        ...
        {isLoading ? (
          <div className="text-center py-32 text-gray-600 text-sm tracking-widest uppercase animate-pulse">Loading gallery…</div>
        ) : filtered.length === 0 ? (
          <div className="text-center py-32 text-gray-600 text-sm tracking-widest uppercase">No photos yet.</div>
        ) : (

    ...
    <div className="min-h-screen">
      ...
      {heroUrl && (
        <div className="relative h-72 md:h-96 overflow-hidden">
          <img src={heroUrl} alt="Our Story" className="w-full h-full object-cover opacity-60" />
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-parchment" />
        </div>
      )}

      <div className={`px-6 ${heroUrl ? 'pt-8' : 'pt-12'} pb-16`}>
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}
            ...
            <Link to="/directory"
              className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-gold hover:text-forest transition-colors">

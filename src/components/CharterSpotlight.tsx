    ...
    <section className="p-6 md:p-8 max-w-7xl">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
        <div>
          ...
          <h2 className="text-4xl font-bold text-forest dark:text-gold font-serif">Charter Spotlight</h2>
        </div>
        <p className="text-gray-500 dark:text-gray-400 max-w-md italic text-sm">
            ...
            >
              <div className="h-44 relative overflow-hidden">
                {(charter as any).hero_image_url ? (
                  ...
                  <div className="w-full h-full bg-amber-50 dark:bg-white/5 flex items-center justify-center">
              ...
              <div className="p-5">
                <h3 className="text-lg font-bold text-forest dark:text-gray-100 group-hover:text-gold transition-colors mb-0.5">{charter.name}</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">{charter.city}, {charter.country}</p>
                {charter.description && (
                  <p className="text-sm text-gray-600 dark:text-gray-300 font-light mb-3 line-clamp-2">{charter.description}</p>
                )}
                <div className="flex items-center justify-between pt-3 border-t border-amber-100 dark:border-white/10 mt-auto">
